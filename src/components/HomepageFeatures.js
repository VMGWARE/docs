...
const FeatureList = [
  {
    ...
    description: (
      <>
        VMG Ware is and always will be totally free. As VMG Ware's{" "}
  ...
  },
  {
    ...
    description: (
      <>
        VMG Ware uses docker containers to execute pipeline steps. If you need
        more than a normal docker image, you can create plugins to extend the
        pipeline features.{" "}
  ...
  },
  {
    ...
    description: (
      <>
        VMG Ware allows you to easily create multiple workflows for your
        project. They can even depend on each other. Check out the{" "}
        <a href="/docs/usage/workflows">docs</a>
      </>
    ),
  },
];
